...
data=pd.read_excel("C:/Users/user/Desktop/py/donnees_bourse1.xlsx")
...
en les remplace par la moyenne , mais dans notre projet on manipule des données finnancies qui sont 
assez sensibles pour cette raison que j ai garder la valeur abberante detecter par 
